    ...
    return (
        <div className="relative flex h-full bg-black">
            <div className="container max-w-screen-xl mx-auto relative z-20 overflow-x-hidden">
                ...
                >
                    <SplideSlide>
                        <Image src={hero1} alt="Poster Brooklyn" style={imageStyle} />
                    </SplideSlide>
                    <SplideSlide>
                        <Image src={hero1} alt="Poster Macao" style={imageStyle} />
                    </SplideSlide>
                    <SplideSlide>
                        <Image src={hero1} alt="Poster Navada" style={imageStyle} />
                    </SplideSlide>
                    <SplideSlide>
                        <Image src={hero1} alt="Poster Brooklyn" style={imageStyle} />
                    </SplideSlide>
